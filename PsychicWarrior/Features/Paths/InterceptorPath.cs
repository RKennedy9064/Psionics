    ...
    public static void Configure()
    {
        ...
        FeatureConfigurator.New("InterceptorPath", Guids.InterceptorPath)
            ...
            .SetDescription(Loc.Str("PW.InterceptorPath.Desc",
                ...
                "\n" +
                "Maneuver: expend psionic focus as a swift action to enter a counter-attack stance — +2 competence to attack and damage for 1 round.\n" +
                "\n" +
                "Expanded Maneuver (Save Another): expend psionic focus to harden your body and absorb blows meant for allies, gaining DR 5/— for 1 round.\n" +
                "\n" +
