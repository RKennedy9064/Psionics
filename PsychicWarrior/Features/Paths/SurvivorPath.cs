    ...
    public static void Configure()
    {
        ...
        FeatureConfigurator.New("SurvivorPath", Guids.SurvivorPath)
            ...
            .SetDescription(Loc.Str("PW.SurvivorPath.Desc",
                ...
                "\n" +
                "Trance (3rd level): while focused, gain DR 2/— and Mettle — when you succeed on a Fortitude or Will save against an effect that normally allows a partial save, you take no effect at all.\n" +
                "\n" +
